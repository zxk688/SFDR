...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json', default='D:/datasets/data/UCM_captions/dataset.json')
    parser.add_argument('--output_dir', default='D:/datasets/resnet101/UCM_Captions')

    # options
    parser.add_argument('--images_root', default='D:/datasets/data/UCM_captions/imgs',
    ...
    parser.add_argument('--model', default='resnet101', type=str, help='resnet101, resnet152, vgg16')
    parser.add_argument('--model_root', default='C:/Users/LJH/.cache/torch/hub/checkpoints/', type=str,
                        help='model root')
